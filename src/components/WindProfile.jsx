    ...
    <div className="w-full bg-slate-900 overflow-x-auto border-t border-slate-700">
      ...
      <table className="w-full text-sm text-center text-slate-300">
        <thead className="text-xs text-slate-400 bg-slate-900 uppercase">
          <tr>
            <th className="px-3 py-3 border-r border-slate-700 font-medium">{t.altitudeAgl}</th>
            <th className="px-3 py-3 border-r border-slate-700 font-medium">{t.windSpeedProfile}</th>
            <th className="px-3 py-3 border-r border-slate-700 font-medium">{t.gustSpeedProfile}</th>
